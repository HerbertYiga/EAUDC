			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li><a href="<c:url value="/ChangeUserPasswords"/>"><i
			...
			<table class="table table-striped table-bordered table-list">
				<thead>
					...
					<tr>
						...
						<th style="color: #1E90FF; text-align: center">Edit</th>
						<th style="color: #1E90FF; text-align: center">Disable</th>
					...
					<c:forEach var="details" items="${list}">
						<tr>
							...
							<td align="center"><a class="btn btn-success"
								href="<c:url value="/enableuser/${details.userId}"/>"><em
									class="glyphicon glyphicon-enable"></em>Enable</a></td>

							<td align="center"><a class="btn btn-warning"
								href="<c:url value="/disableuser/${details.userId}"/>"><em
									class="glyphicon glyphicon-enable"></em>Disable</a></td>
